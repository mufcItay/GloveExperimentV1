...
namespace Assets.Scripts
{
    public interface IMovingAverage <T>
    {
        ...
        void ClearSamples();
        void InitializeSamples(T val);
    }

    class MovingAvarage : IMovingAverage<float>
    {
        ...
        public MovingAvarage(int nSamples)
        {
            if (nSamples <= 0)
            {
            ...
            samples = new CircularList<float>(nSamples);
            total = 0;
        }
